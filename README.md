...
* 6) Αν διαφωνείτε με κάποια ανάρτηση ή σχόλιο, ενημερώστε τους [διαχειριστές της κοινότητας][9].
* 7) Απαγορεύεται η δημοσίευση πορνογραφικού, απειλητικού, ρατσιστικού ή προσβλητικού υλικού, για κοινωνικές ομάδες, μειονότητες, εθνότητες και θρησκείες.
* 8) Σεβαστείτε τους κανόνες ["Ανοιχτού Σεβασμού"] [5] 
